...
class BaseContentParserStrategy {
...
class TextContentParserStrategy extends BaseContentParserStrategy {
...
class JSONContentParserStrategy extends BaseContentParserStrategy {

    constructor({ limit = '10mb' } = {}) {
        super({ limit, type: 'string' })
    }

    async parse(request, source) {
        return JSON.parse(await super.parse(request, source))
    }

}

module.exports = { BaseContentParserStrategy, TextContentParserStrategy, JSONContentParserStrategy }